...
-- Yes, this is a copy in case I fuck up royally.
...
--         object.update = function(self, dt)
--             -- animate the continueMarker
--             -- if Input.lock == self.lock then
--             --     if love.keyboard.isDown(Config.keys.confirm) then
--             --         -- self:destroy()
--             --         self:scrollToDeath()
--             --         return
--             --     end
...
--                     script.character = script.character + 1
--                     Input.lock = "reading"
--                     if love.keyboard.isDown(Config.keys.confirm) and Input.lock == "reading" then
--                         script.character = #script.text
--                         -- Input.lock = "pressed"
--                     end
--                 else
--                     Input.lock = "pressed"
...
--                     if not love.keyboard.isDown(Config.keys.confirm) then
--                         Input.lock = self.lock
--                     end
--                 end
--             end
